...
export const ALL_PROJECTS: (Project & { slug: string })[] = [
  ...
  },
  {
    ...
    title: 'CampusPulse',
    description:
      'Plateforme d\'enquête environnementale et d\'analyse de données pour le campus de l\'ESPA Vontovorona — collecte, dashboard admin et statistiques en temps réel.',
    tech: ['React 19', 'Vite', 'Tailwind CSS', 'Supabase', 'PostgreSQL', 'Recharts', 'ExcelJS', 'React Router 7'],
    category: 'Fullstack',
    year: '2026',
    status: 'Livré',
    statusColor: 'text-success bg-success/10 border-success/20',
    gradient: 'from-secondary/20 via-secondary/10 to-primary/10',
    accentColor: 'text-secondary',
    headerImage: '/projects/campuspulse/header.svg',
    screenshotImages: [
      '/projects/campuspulse/screenshots/screenshot-1.webp',
      '/projects/campuspulse/screenshots/screenshot-2.webp',
      '/projects/campuspulse/screenshots/screenshot-3.webp',
      '/projects/campuspulse/screenshots/screenshot-4.webp',
      '/projects/campuspulse/screenshots/screenshot-5.webp',
    ],
