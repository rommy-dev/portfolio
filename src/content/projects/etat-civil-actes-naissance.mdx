...
- **Cohérence fullstack** : garder une correspondance claire entre les données exposées par l'API et les écrans React
...
Ce projet montre ma capacité à intervenir sur une application fullstack complète dans un contexte institutionnel, avec des contraintes plus fortes qu'un projet personnel classique.

Il met en avant :

- Ma prise en main de **Symfony**, **API Platform**, **Doctrine** et l'écosystème PHP moderne
